            ...
            <div class="col-xl-10">
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-6 p-5">
                                ...
                                <h6 class="h5 mb-0 mt-4">Modifier le mot de passe</h6>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-muted">Revenir à <a href="pages-login.html"
                                class="text-primary font-weight-bold ml-1">Connexion</a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
